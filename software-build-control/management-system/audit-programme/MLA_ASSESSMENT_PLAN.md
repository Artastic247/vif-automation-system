...
## Purpose
Define M0 to M5 maturity assessment for the factory.

## Scope
Processes, workflows, prompts, prompt generator, workflow manager, agents, WIs, validators, standards-control, automation readiness, app onboarding readiness, app-repo CI readiness and n8n readiness.

## Audit owner/agent
MLA Assessor.

## Audit object
Maturity evidence and automation permission.

## Audit criteria
Each area must define M0-M5 evidence, automation permission, audit frequency and upgrade/downgrade triggers.
