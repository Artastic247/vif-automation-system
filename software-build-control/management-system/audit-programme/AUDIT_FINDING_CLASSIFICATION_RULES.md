# AUDIT_FINDING_CLASSIFICATION_RULES

## Purpose
Define finding classes, severity, containment, RCA/CAPA and gate impact.

## Scope
Observation, minor, major, blocked gate, false PASS, source-required, customer-source-required, app-source-required, security/RLS, customer-data, prompt drift, workflow drift, validator failure and automation-maturity findings.

## Audit owner/agent
Internal Audit Specialist with QA Gatekeeper.

## Audit object
Audit findings and classification decisions.

## Audit criteria
Each finding type must define severity, immediate containment, RCA requirement, CAPA requirement, gate impact and escalation.
