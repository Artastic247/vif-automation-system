# EXTERNAL_COMPLIANCE_AUDIT_PLAN

## Purpose
Define external standards-lens audit without making compliance or certification claims.

## Scope
ISO 9001-style clause 4-10 structure, ISO/TS 9002 guidance logic, ISO 9004 maturity logic, IATF-style process discipline, ISO/IEC 27001 security lens, ISO 31000/31010 risk lens, ISO/IEC 42001 AI management lens, customer-specific and app-specific requirements where supplied.

## Audit owner/agent
Compliance Specialist with Compliance Claim Approver.

## Audit object
Standards-lens audit evidence and claim-control linkage.

## Audit criteria
No compliance claim, no certification-readiness claim, SOURCE REQUIRED controls, CUSTOMER SOURCE REQUIRED controls and APP SOURCE REQUIRED controls must be maintained.
