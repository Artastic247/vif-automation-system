# MASTER_AUDIT_PROGRAMME

## Purpose
Define the full operational audit programme for the app-development automation system.

## Scope
Full process audit, systems audit, MLA assessment, external standards-lens audit, prompt/prompt-generator audit and workflow-manager audit.

## Audit owner/agent
Internal Audit Specialist with QA Gatekeeper.

## Audit object
Audit programme covering files, prompts, prompt generator, workflow manager, processes, agents, skills/WIs, validators and gates.

## Audit criteria
Audit types, frequency, triggers, owners, evidence, findings, escalation and management-review linkage must be defined.
