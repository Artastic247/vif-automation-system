# WORKFLOW_MANAGER_AUDIT_PLAN

## Purpose
Audit the workflow manager that creates and controls workflows in the app-development solution.

## Scope
Workflow trigger, actor, runtime object, state model, allowed next actions, protected actions, evidence, approvals, exception route, handoff, lifecycle state, change control and deactivation/supersede logic.

## Audit owner/agent
Workflow Manager Auditor with Runtime Architect.

## Audit object
Workflow definitions and runtime workflow controls.

## Audit criteria
Workflow audit must cover backend, UI/interface, database/RLS, prompt generation, job card, validation, release/rollback, RCA/CAPA, continual improvement, app onboarding, GitHub CI readiness and n8n readiness workflows.
