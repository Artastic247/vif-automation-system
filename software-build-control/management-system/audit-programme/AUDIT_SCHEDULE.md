...
## Purpose
Define when each audit type is performed and what triggers additional audits.

## Scope
Process audits, systems audits, MLA assessments, standards-lens audits, prompt audits, workflow-manager audits and app-development process audits.

## Audit owner/agent
Internal Audit Specialist.

## Audit object
Audit calendar, risk-based audit triggers and maturity-based audit frequency.

## Audit criteria
High-risk, low-maturity and automation-related areas must be audited more frequently. App onboarding audit is blocked until integrated validation passes.
