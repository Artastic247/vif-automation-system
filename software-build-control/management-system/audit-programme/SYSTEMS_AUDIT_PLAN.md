...
## Purpose
Audit whether the factory operates as a connected system.

## Scope
Process-to-agent, process-to-WI, process-to-validator, process-to-prompt, prompt-to-job-card, workflow-to-runtime-object, validator-to-gate, finding-to-NC/RCA/CAPA, lessons-to-update and standards-to-claim-control linkage.

## Audit owner/agent
QA Gatekeeper with Systems Auditor.

## Audit object
System linkages and handoffs.

## Audit criteria
No process, prompt, workflow, validator, finding, RCA/CAPA or lesson may operate as an isolated island.
