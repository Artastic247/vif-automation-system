...
## Purpose
Define evidence types, storage and quality rules for audits.

## Scope
File paths, commit SHAs, tree SHAs, validation reports, script output, screenshots where applicable, workflow state evidence, prompt text/output, approval records, findings, RCA/CAPA, lessons and management-review inputs.
...
## Audit criteria
Evidence must be traceable, current, linked to process/finding/gate and adequate for the claim being made.
