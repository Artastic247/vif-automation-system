# APP_DEVELOPMENT_PROCESS_AUDIT_CHECKLIST

## Purpose
Audit actual app-development activities, not only document existence.

## Scope
Intake, context capture, source-of-truth lock, app scope, backend, frontend/UI, workflow/runtime, database/RLS/security, prompt use, agent assignment, WI use, validation evidence, release/rollback readiness, app onboarding readiness, customer-data boundary and mock/demo data boundary.

## Audit owner/agent
App Development Process Auditor.

## Audit object
App-development execution activity and evidence.

## Audit criteria
The audit must prove runtime-first behaviour and protected-scope control. UI shell alone does not prove module completion.
