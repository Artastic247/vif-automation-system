...
## Purpose
Audit the actual app-development and management-system processes.

## Scope
ADP-01 to ADP-21, MOP/COP/SOP processes, backend, UI/interface, workflow/runtime, database/RLS, intake/context/source lock, verification/validation/release and support/maintenance/change.

## Audit owner/agent
Process Engineer with Internal Audit Specialist.

## Audit object
Defined processes and process execution evidence.

## Audit criteria
Each process must show purpose, owner, inputs, activities, outputs, resources/tools, WIs, evidence, KPI, risks/controls, interface, runtime object where applicable, gate, PDCA, audit trail and maturity level.
